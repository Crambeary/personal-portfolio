    ...
    <>
      <div className="flex w-full flex-col justify-center">
        <div className="justify-center text-left my-4 sm:my-64 mx-4 sm:ml-24">
          <h1 className="text-3xl sm:text-5xl my-32 sm:mb-64 leading-relaxed sm:pb-4 font-bold motion-preset-blur-right bg-gradient-to-r from-black dark:from-primary dark:to-gray-400 bg-clip-text text-transparent">
            Crafting Intuitive Front-End <span className="text-border font-serif italic">Experiences</span>
          </h1>
          <div>
            <h2 className="text-xl sm:text-2xl mt-4 font-bold motion-delay-200 motion-preset-blur-right bg-gradient-to-r from-black dark:from-primary dark:to-gray-400 bg-clip-text text-transparent">
              ...
              , a Front-End Developer <span>passionate about building engaging web
